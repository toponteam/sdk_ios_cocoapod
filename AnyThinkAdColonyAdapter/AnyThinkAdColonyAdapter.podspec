#
# Be sure to run `pod lib lint AnyThinkAdColonyAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkAdColonyAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkAdColonyAdapter.'

  s.description      = <<-DESC
    TopOn SDK for developer
                       DESC

  s.homepage = 'https://github.com/bo/AnyThinkAdColonyAdapter'
  ...
  # s.source_files = 'AnyThinkAdColonyAdapter/Classes/**/*'
  s.source = {
