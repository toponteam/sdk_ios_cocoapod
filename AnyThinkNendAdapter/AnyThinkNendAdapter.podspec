#
# Be sure to run `pod lib lint AnyThinkNendAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkNendAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkNendAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkNendAdapter'
  ...
  # s.source_files = 'AnyThinkNendAdapter/Classes/**/*'
  s.source = {
  ...
  s.dependency 'NendSDK_iOS','7.0.6'
