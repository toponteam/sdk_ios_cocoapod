#
# Be sure to run `pod lib lint AnyThinkTTAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkTTAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkTTAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkTTAdapter'
