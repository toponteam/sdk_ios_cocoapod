#
# Be sure to run `pod lib lint AnyThinkIronSourceAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkIronSourceAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkIronSourceAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkIronSourceAdapter'
  ...
  # s.source_files = 'AnyThinkIronSourceAdapter/Classes/**/*'
  s.source = {
