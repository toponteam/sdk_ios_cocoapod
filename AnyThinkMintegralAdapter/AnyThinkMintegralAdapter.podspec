#
# Be sure to run `pod lib lint AnyThinkMintegralAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkMintegralAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkMintegralAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkMintegralAdapter'
  ...
  # s.source_files = 'AnyThinkMintegralAdapter/Classes/**/*'
  s.source = {
  ...
  s.dependency 'MintegralAdSDK/All','7.1.0'
