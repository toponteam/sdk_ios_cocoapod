#
# Be sure to run `pod lib lint AnyThinkPangleAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkPangleAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkPangleAdapter.'
...
TODO: Add long description of the pod here.
  ...
  s.dependency 'Ads-Global-Beta','4.3.0.2'
