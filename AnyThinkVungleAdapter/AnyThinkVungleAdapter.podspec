#
# Be sure to run `pod lib lint AnyThinkVungleAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkVungleAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkVungleAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkVungleAdapter'
  ...
  # s.source_files = 'AnyThinkVungleAdapter/Classes/**/*'
  s.source = {
