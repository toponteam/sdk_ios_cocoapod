#
# Be sure to run `pod lib lint AnyThinkTapjoyAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkTapjoyAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkTapjoyAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkTapjoyAdapter'
  ...
  # s.source_files = 'AnyThinkTapjoyAdapter/Classes/**/*'
  s.source = {
