#
# Be sure to run `pod lib lint AnyThinkOguryAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkOguryAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkOguryAdapter'
  ...
  # s.source_files = 'AnyThinkOguryAdapter/Classes/**/*'
  s.source = {
