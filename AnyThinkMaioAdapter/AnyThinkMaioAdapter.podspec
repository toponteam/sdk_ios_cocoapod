#
# Be sure to run `pod lib lint AnyThinkMaioAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkMaioAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkMaioAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkMaioAdapter'
  ...
  # s.source_files = 'AnyThinkMaioAdapter/Classes/**/*'
  s.source = {
