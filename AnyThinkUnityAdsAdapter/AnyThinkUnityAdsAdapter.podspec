#
# Be sure to run `pod lib lint AnyThinkUnityAdsAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkUnityAdsAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkUnityAdsAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkUnityAdsAdapter'
  ...
  # s.source_files = 'AnyThinkUnityAdsAdapter/Classes/**/*'
  s.source = {
