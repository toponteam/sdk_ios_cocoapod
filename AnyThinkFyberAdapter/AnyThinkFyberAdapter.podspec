#
# Be sure to run `pod lib lint AnyThinkFyberAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkFyberAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkFyberAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkFyberAdapter'
  ...
  # s.source_files = 'AnyThinkFyberAdapter/Classes/**/*'
  s.source = {
