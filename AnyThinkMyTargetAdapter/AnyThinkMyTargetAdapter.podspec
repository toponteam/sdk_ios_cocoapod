#
# Be sure to run `pod lib lint AnyThinkMyTargetAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkMyTargetAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkMyTargetAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkMyTargetAdapter'
  ...
  # s.source_files = 'AnyThinkMyTargetAdapter/Classes/**/*'
  s.source = {
  ...
  s.dependency 'myTargetSDK','5.13.0'
