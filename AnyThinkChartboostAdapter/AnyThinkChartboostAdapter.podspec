#
# Be sure to run `pod lib lint AnyThinkChartboostAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkChartboostAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkChartboostAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkChartboostAdapter'
  ...
  # s.source_files = 'AnyThinkChartboostAdapter/Classes/**/*'
  s.source = {
  ...
  s.dependency 'ChartboostHelium','2.3.1'
