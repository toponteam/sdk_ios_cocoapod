Pod::Spec.new do |spec|
  ...
  spec.subspec 'AnyThinkSDK' do |ss|
     ...
     ss.vendored_frameworks = 'AnyThinkiOS/AnyThink{Banner,Splash,SDK,RewardedVideo,Interstitial,HeaderBidding,Native,MyOffer,MyOfferInterstitial,MyOfferRewardedVideo}.framework','AnyThinkiOS/TraminiSDK.framework'
