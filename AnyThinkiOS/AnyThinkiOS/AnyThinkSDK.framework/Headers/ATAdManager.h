...
/*
 * We mark this method as deprecated because we move customData into ATAPI's shared instance.
 * customData passed via this method will just be ignored.
 */
- (void)loadADWithPlacementID:(NSString*)placementID
                        extra:(NSDictionary*)extra
                   customData:(NSDictionary*)customData
                     delegate:(id<ATAdLoadingDelegate>)delegate DEPRECATED_ATTRIBUTE;
