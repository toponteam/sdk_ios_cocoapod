#
# Be sure to run `pod lib lint AnyThinkBaiduAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkBaiduAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkBaiduAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkBaiduAdapter'
  ...
  # s.source_files = 'AnyThinkBaiduAdapter/Classes/**/*'
  s.source = {
  ...
  s.dependency 'BaiduMobAdSDK','4.85'
