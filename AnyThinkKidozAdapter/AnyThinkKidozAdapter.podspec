#
# Be sure to run `pod lib lint AnyThinkKidozAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AnyThinkKidozAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnyThinkKidozAdapter.'

  s.description      = <<-DESC
TODO: Add long description of the pod here.
                       DESC

  s.homepage         = 'https://github.com/bo/AnyThinkKidozAdapter'
  ...
  # s.source_files = 'AnyThinkKidozAdapter/Classes/**/*'
  s.source = {
  ...
  s.dependency 'AnyThinkKidozSDK','1.3.6'
